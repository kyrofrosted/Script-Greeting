...
local function getMessage(category) -- get a fun message based on the category, uwu
    local funFacts = { -- all the fun facts, nya
        ...
        "[Fun Fact]: why are you still reading this? get a life!",
        "[Fun Fact]: if you think this script is complex, try deciphering my thoughts!",
        "[Fun Fact]: coding is my therapy, so be grateful I'm not ranting!",
        "[Fun Fact]: did you know my favorite pastime is debugging? sad, right?",
        "[Fun Fact]: I once tried to teach a bot to tell jokes. It still hates me.",
        "[Fun Fact]: there’s no ‘i’ in team, but there is in ‘me’!",
        "[Fun Fact]: someone once told me I have a future in coding. they lied.",
        "[Fun Fact]: yes, I’ve heard of the Turing Test. I’ve failed it numerous times.",
        "[Fun Fact]: they say laughter is the best medicine, but I prefer lines of code.",
        "[Fun Fact]: if you find my humor dry, you should see my code comments!",
        "[Fun Fact]: I’m not a hoarder; I’m just really into keeping unnecessary data.",
        "[Fun Fact]: my code is like a buffet: take what you want, leave the rest.",
        "[Fun Fact]: ever notice how debugging feels like a never-ending loop? me neither.",
        "[Fun Fact]: the real fun fact is that you’re still here!",
        "[Fun Fact]: I’ve been coding so long, my keyboard thinks it’s my therapist.",
        "[Fun Fact]: my code has more bugs than a rainforest, and it’s still growing.",
        "[Fun Fact]: sometimes, I code just to feel alive. other times, I just feel tired.",
        "[Fun Fact]: I hope you find this script as interesting as I find caffeine.",
    }
    local advice = { -- all the advice messages, nya
        ...
        "[Advice]: if you encounter an error, don’t panic. take a deep breath and debug.",
        "[Advice]: keep your code modular and reusable for better maintainability.",
        "[Advice]: avoid hardcoding values; use variables for better flexibility.",
        "[Advice]: always document your functions and their parameters.",
        "[Advice]: break down complex problems into smaller, manageable chunks.",
        "[Advice]: regularly commit your code to version control.",
        "[Advice]: embrace failure as a learning opportunity.",
        "[Advice]: remember, there’s no one-size-fits-all solution in coding.",
        "[Advice]: take time to review and refactor your code for improvements.",
        "[Advice]: engage with the coding community for fresh perspectives and ideas.",
        "[Advice]: stay updated with the latest coding practices and technologies.",
        "[Advice]: never underestimate the power of a good code review.",
        "[Advice]: use version control to keep track of changes and collaborate effectively.",
        "[Advice]: don’t be afraid to ask for help; even experts need guidance.",
        "[Advice]: keep a coding journal to track your progress and challenges.",
        "[Advice]: practice coding regularly to sharpen your skills.",
        "[Advice]: explore new programming languages to broaden your horizons.",
        "[Advice]: make time for creative projects outside of work to stay inspired.",
        "[Advice]: remember, the best code is simple, readable, and efficient."
    }
